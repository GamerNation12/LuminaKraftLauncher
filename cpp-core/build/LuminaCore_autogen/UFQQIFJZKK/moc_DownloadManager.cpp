...
#include "../../../src/network/DownloadManager.h"
...
void DownloadManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DownloadManager::*)(int , int )>(_a, &DownloadManager::progressChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (DownloadManager::*)()>(_a, &DownloadManager::finished, 1))
            return;
    }
}
...
// SIGNAL 0
void DownloadManager::progressChanged(int _t1, int _t2)
{
